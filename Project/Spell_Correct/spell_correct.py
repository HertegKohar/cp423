...
def get_closest_match(term, matches, inverted_index):
    ...
    """
    # 1. get all edit distance 1 words, if exactly 1 then use it, else...
    # 1.a. if none, then move to step 2, else...
    # 1.b. use the term with the highest term frequency
    # 2. get all edit distance 2 words, if exactly 1 then use it, else...
    # 2.a. if none, then move to step 3, else...
    # 2.b. use the term with the highest term frequency
